...
/*   Updated: 2019/09/15 00:45:19 by fmakgoka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
struct s_node		*ft_put(int agc, char **agv);
...
void				print(t_node *struct_a, t_node *struct_b);
...
void				interval(t_node **stack_a, t_node **stack_b, int min,\
																int max);
